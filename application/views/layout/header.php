...
<head>
	...
	<link href="<?= base_url('assets/') ?>vendors/base/vendors.bundle.rtl.css" rel="stylesheet" type="text/css" />
	<link href="<?= base_url('assets/') ?>demo/demo5/base/style.bundle.css" rel="stylesheet" type="text/css" />

	<link href="<?= base_url('assets/') ?>demo/demo5/base/style.bundle.rtl.css" rel="stylesheet" type="text/css" />
